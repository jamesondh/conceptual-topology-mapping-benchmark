...
\input{01-introduction}     % Section 1: Introduction
\input{02-benchmark}        % Section 2: The Benchmark
\input{03-related-work}     % Section 3: Related Work
\input{04-structure}        % Section 4: Act I -- Structure
\input{05-topology}         % Section 5: Act II -- Topology
\input{06-mechanism}        % Section 6: Act III -- Mechanism
\input{07-limits}           % Section 7: Act IV -- Limits
\input{08-generality}       % Section 8: Act V -- Generality
\input{09-robustness}       % Section 9: Act VI -- Robustness
\input{10-discussion}       % Section 10: Discussion
\input{11-conclusion}       % Section 11: Conclusion
...
\input{A-concept-pairs}        % Appendix A: Concept Pair Inventory
\input{B-phase-results}        % Appendix B: Phase-by-Phase Results
\input{C-graveyard}            % Appendix C: Dead Ends and Failed Hypotheses
\input{D-prompt-templates}     % Appendix D: Prompt Templates
\input{E-statistical-methods}  % Appendix E: Statistical Methods
\input{F-robustness-details}   % Appendix F: Robustness Details
