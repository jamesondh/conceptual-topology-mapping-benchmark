\section{Act III --- Mechanism: Pre-Filling Reveals Causal Structure}\label{act-iii-mechanism-pre-filling-reveals-causal-structure}
...
\subsection{Pre-Filling Causally Displaces Bridges}\label{pre-filling-causally-displaces-bridges}
...
\subsection{The Mechanism Is Primarily Associative Primacy}\label{the-mechanism-is-primarily-associative-primacy}
...
\textbf{The directional-heading theory fails in its strong form.} Displacement magnitudes were statistically indistinguishable across conditions:
...
\textbf{The relation class taxonomy captures real variance.} A Friedman test across 8 pairs confirmed that relation class significantly affects bridge survival (chi-squared = 6.750, df = 2, p = 0.034).
...
\textbf{Marginal bridges show large facilitation under aligned pre-fill.} Across four marginal pairs (unconstrained frequency 0.125--0.267), mean congruent survival was 3.761×, driven by three strong cases:
